...
$query_DatosConsulta = sprintf("SELECT * FROM tbldescuento WHERE refPadre=0".$cadenaOrden);
...
<div id="wrapper">
  ...
  <div id="page-wrapper">
     <div class="row">
           ...
           <div class="row">
                <div class="col-lg-5">
                	<a value="Añadir Descuento" href="discount-add.php" class="btn btn-outline btn-primary">Añadir Descuento</a>
                	<br>
                	<br>
			   </div>
	  		</div>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                       <?php 
										...
										<tr>
											<td><?php echo $row_DatosConsulta["idGrupo"];?></td>
											...
											<td></td>
									  		...
									  		<th></th>
										  	<td>
										  		<a href="discount-edit.php?id=<?php echo $row_DatosConsulta["idGrupo"];?>" class="btn btn-warning btn-circle" title="Edición de Descuentos">
												<i class="fa fa-edit"></i></a>
												<a href="discountdetail-add.php?id=<?php echo $row_DatosConsulta["idGrupo"];?>" class="btn btn-success btn-circle" title="Añadir elementos a Descuentos">
												<i class="fa fa-plus"></i></a>
											</td>
										</tr>
              		
              							<?php
												 DiscountAdminLevelOption($row_DatosConsulta["idGrupo"], "-- ");
