...
if ((isset($_GET["MM_search"])) && ($_GET["MM_search"]=="formsearch"))
{
	...
	$query_DatosConsulta = "SELECT * FROM tblimpuesto WHERE (".$extramodelo.")  ".$consultaextendida.$cadenaOrden;
...
<div id="wrapper">
  ...
  <div id="page-wrapper">
     <div class="row">
           ...
           <div class="row">
                <div class="col-lg-5">
                	<a value="Añadir Tasa o Impuesto" href="taxes-add.php" class="btn btn-outline btn-primary">Añadir Tasa o Impuesto</a>
                </div>
                <div class="col-lg-7">
                	<div class="well">
										...
										//AQUI ES DONDE SE SACAN LOS DATOS, SE COMPRUEBA QUE HAY RESULTADOS 
              							...
              							?>
											...
											<tr>
												...
												<td><a href="taxes-edit.php?id=<?php echo $row_DatosConsulta["idImpuesto"];?>" title="<?php echo $row_DatosConsulta["strNombre"];?>" class="btn btn-warning btn-circle"><i class="fa fa-edit"></i></a></td>
											</tr>
