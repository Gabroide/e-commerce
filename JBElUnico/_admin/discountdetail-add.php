...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "forminsertar")) {
	...
	$insertSQL = sprintf("INSERT INTO tbldescuento(strNombre, intEstado, refPadre, dblInferior, dblSuperior, dblCoste) VALUES (%s, %s, %s, %s, %s, %s)",
...
<div id="wrapper">
  ...
  <div id="page-wrapper">
     <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Gestión de Descuentos</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
...
`                         <!-- /.panel-heading -->
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="discountdetail-add.php" method="post" id="forminsert" name="forminsert">
                                        <div class="form-group">
                                            <label for="strNombre">Nombre del Descuento</label>
                                        ...
                                        <div class="alert alert-danger hiddeit" id="errornombre">
                                        	El campo Nombre del Descuento es obligatorio.
                                        </div>
                                        <div class="form-group">
