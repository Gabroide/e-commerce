...
if (isset($_GET["valor"]))
{
	switch ($_GET["valor"]) {
    case 1:
        $parametro_orden= "idMoneda";
        break;
    case 2:
        $parametro_orden= "strNombre";
        break;
    case 3:
        $parametro_orden= "dblValor";
        break;
    }
}
else
	$parametro_orden= "idMoneda"; //POR DEFECTO
...
if ((isset($_GET["MM_search"])) && ($_GET["MM_search"]=="formsearch"))
{
	...
	$query_DatosConsulta = "SELECT * FROM tblmoneda WHERE (".$extramodelo.")  ".$consultaextendida.$cadenaOrden;
	//echo $query_DatosConsulta;
}
else
{
	$query_DatosConsulta = sprintf("SELECT * FROM tblmoneda ".$cadenaOrden);
	}
...
<div id="wrapper">
  ...
  <div id="page-wrapper">
     <div class="row">
           ...
           <div class="row">
                <div class="col-lg-5">
                	<a value="Añadir Monedas" href="coin-add.php" class="btn btn-outline btn-primary">Añadir Moneda</a>
                </div>
                <div class="col-lg-7">
                	<div class="well">
                                       ...
                                       <?php 
										//AQUI ES DONDE SE SACAN LOS DATOS, SE COMPRUEBA QUE HAY RESULTADOS 
              							...
              							?>
											...
											<tr>
												<td><?php echo $row_DatosConsulta["idMoneda"];?></td>
												<td><?php echo $row_DatosConsulta["strNombre"];?> - <?php echo $row_DatosConsulta["strSimbolo"];?><?php if($row_DatosConsulta["intPrincipal"]==1)
												{ 
													echo " [Principal]";
												}
												 else
												 {?>
													<a href="main-coin.php?id=<?php echo $row_DatosConsulta["idMoneda"];?>" title="Marcar como moneda principal"> Hacer Principal</a>
												 <?php };?></td>
												<td><?php echo $row_DatosConsulta["dblValor"];?></td>
												<td><a href="coin-edit.php?id=<?php echo $row_DatosConsulta["idMoneda"];?>" title="Editar <?php echo $row_DatosConsulta["strNombre"];?>" class="btn btn-warning btn-circle"><i class="fa fa-edit"></i></a></td>
											</tr>
