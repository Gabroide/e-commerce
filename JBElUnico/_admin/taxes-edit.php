...
<?php
$query_DatosConsulta = sprintf("SELECT * FROM tblimpuesto WHERE idImpuesto=%s", GetSQLValueString($_GET["id"], "int"));
...
`                         <!-- /.panel-heading -->
                        <div class="panel-body">
                        	Editar Tasa o Impuesto
                        	<!-- /.table-responsive -->
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="taxes-edit.php" method="post" id="forminsert" name="forminsert">
                                        <div class="form-group">
                                            <label for="strNombre">Nombre del Impuesto</label>
                                            <input class="form-control" placeholder="Escribir el Nombre del Impuesto" name="strNombre" id="strNombre" value="<?php echo $row_DatosConsulta["strNombre"];?>">
                                        </div>
                                        <div class="alert alert-danger hiddeit" id="errornombre">
                                        	El campo Nombre es obligatorio.
                                        </div>
                                        <div class="form-group">
                                            <label for="dblImpuesto">Valor (%)</label>
                                            <input class="form-control" placeholder="21,00" name="dblImpuesto" id="dblImpuesto" value="<?php echo $row_DatosConsulta["dblImpuesto"];?>">
                                        </div>
                                        <div class="alert alert-danger hiddeit" id="errornombre">
                                        	El campo Valor es obligatorio.
                                        </div>
                                        <button type="submit" class="btn btn-success" value="Editar">Editar</button>
                                        <input type="hidden" name="idImpuesto" id="idImpuesto" value="<?php echo $row_DatosConsulta["idImpuesto"];?>">                                       
