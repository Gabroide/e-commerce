...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "forminsert")) {
  ...
  $updateSQL = sprintf("UPDATE tbldescuento SET strNombre=%s, intEstado=%s WHERE idGrupo=%s",
...
`                         <!-- /.panel-heading -->
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form action="discount-edit.php" method="post" id="forminsert" name="forminsert" role="form">
                                        <div class="form-group">
                                            <label for="strNombre">Nombre del Descuento</label>
                                            <input class="form-control" placeholder="Escribir Nombre del Descuento" name="strNombre" id="strNombre" value="<?php echo $row_DatosConsulta["strNombre"];?>">
                                        </div>
