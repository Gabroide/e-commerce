...
`                         <!-- /.panel-heading -->
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form action="characdetail-edit.php" method="post" id="forminsert" name="forminsert" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Escribir Orden de la Característica" name="intOrden" id="intOrden" value="<?php echo $row_DatosConsulta["intOrden"];?>">
                                        </div>
