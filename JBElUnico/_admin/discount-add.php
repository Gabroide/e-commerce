...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "forminsertar")) {
	...
	$insertSQL = sprintf("INSERT INTO tbldescuento(strNombre, intEstado, refPadre) VALUES (%s, %s, %s)",
...
<div id="wrapper">
  ...
  <div id="page-wrapper">
     <div class="row">
			...
			<a href="discount-list.php" class="btn btn-outline btn-info">Volver atrás</a>
			<br>
			<br>
...
`                         <!-- /.panel-heading -->
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="discount-add.php" method="post" id="forminsert" name="forminsert">
                                        <div class="form-group">
                                            <label for="strNombre">Nombre del Descuento</label>
                                            <input class="form-control" placeholder="Escribir Nombre del Descuento" name="strNombre" id="strNombre">
                                        </div>
                                        <div class="alert alert-danger hiddeit" id="errornombre">
                                        	El campo Nombre de Descuento es obligatorio.
                                        </div>
                                        <div class="form-group">
