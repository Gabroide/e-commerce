...
if (isset($_POST['email'])) {
  ...
  if ($loginFoundUser) {
    ...
    $_SESSION['tienda2020_UserId'] = mysqli_result($LoginRS,0,'idUsuario');
    $_SESSION['tienda2020_Mail'] = mysqli_result($LoginRS,0,'strEmail');
    $_SESSION['tienda2020_Nivel'] = mysqli_result($LoginRS,0,'intNivel');
