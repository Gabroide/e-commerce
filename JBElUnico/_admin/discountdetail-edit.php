...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "forminsert")) {
  ...
  $updateSQL = sprintf("UPDATE tbldescuento SET strNombre=%s, intEstado=%s, dblInferior=%s, dblSuperior=%s, dblCoste=%s WHERE idGrupo=%s",
					   ...
					   GetSQLValueString(ProcessComaCost($_POST["dblCoste"]), "double"),
					   GetSQLValueString($_POST["idGrupo"], "int"));

//echo $updateSQL;
$Result1 = mysqli_query($con, $updateSQL) or die(mysqli_error($con));

  $updateGoTo = "discount-list.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$query_DatosConsulta = sprintf("SELECT * FROM tbldescuento WHERE idGrupo=%s", GetSQLValueString($_GET["id"], "int"));
...
<div id="wrapper">
  ...
  <div id="page-wrapper">
     <div class="row">
			...
			<a href="discount-list.php" title="Volver Atrás" class="btn btn-outline btn-info">Volver atrás</a>
			<br>
			<br>
...
`                         <!-- /.panel-heading -->
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form action="discountdetail-edit.php" method="post" id="forminsert" name="forminsert" role="form">
                                        ...
                                        <div class="form-group">
                                        	<label for="dblInferior">Cantidad Inferior</label>
                                            <input class="form-control" name="dblInferior" id="dblInferior" value="<?php echo $row_DatosConsulta["dblInferior"];?>">
                                        </div>
                                        <div class="form-group">
                                        	<label for="dblSuperior">Cantidad Superior</label>
                                            <input class="form-control" name="dblSuperior" id="dblSuperior" value="<?php echo $row_DatosConsulta["dblSuperior"];?>">
                                        </div>
                                        <div class="form-group">
                                        	<label for="dblCoste">Descuento</label>
                                            <input class="form-control" name="dblCoste" id="dblCoste" value="<?php echo $row_DatosConsulta["dblCoste"];?>">
                                        </div>
										<div class="form-group">
