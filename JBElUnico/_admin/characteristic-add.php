...
`                         <!-- /.panel-heading -->
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="characteristic-add.php" method="post" id="forminsert" name="forminsert">
                                        <div class="form-group">
                                            <label for="strNombre">Nombre de la Característica</label>
                                            <input class="form-control" placeholder="Escribir Nombre de la Característica" name="strNombre" id="strNombre">
                                        </div>
                                        <div class="alert alert-danger hiddeit" id="errornombre">
                                        	El campo Nombre de Característica es obligatorio.
                                        </div>
                                        <div class="form-group">
                                            <label for="intOrden">Orden de Característica</label>
                                            <input class="form-control" placeholder="Orden de la Característica" name="intOrden" id="intOrden">
                                        </div>
