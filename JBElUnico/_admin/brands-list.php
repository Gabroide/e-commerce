...
<div id="wrapper">
  ...
  <div id="page-wrapper">
     <div class="row">
           ...
           <div class="row">
                <div class="col-lg-5">
                	<a value="Añadir Marca" href="brands-add.php" class="btn btn-outline btn-primary">Añadir Marca</a>
                </div>
                <div class="col-lg-7">
                	<div class="well">
										...
										//AQUI ES DONDE SE SACAN LOS DATOS, SE COMPRUEBA QUE HAY RESULTADOS 
              							...
              							?>
											...
											<tr>
												...
												<td><a href="brands-edit.php?id=<?php echo $row_DatosConsulta["idMarca"];?>" class="btn btn-warning btn-circle"><i class="fa fa-edit"></i></a></td>
											</tr>
